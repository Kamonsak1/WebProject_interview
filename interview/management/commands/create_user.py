...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        users_stuedbt= [
            {'username': '6701920033','email': 'None','password': 'mavnhb','first_name':'นายธาราธร' ,'last_name':'บุญประดับ'},
            {'username': '6701920060','email': 'None','password': 'qwdgyy','first_name':'นายพีรพัฒน์' ,'last_name':'หงษ์สินี'},
            {'username': '6701920106','email': 'None','password': 'owwfhm','first_name':'นายภาคิน' ,'last_name':'วิลามาศ'},
            {'username': '6701920208','email': 'None','password': 'sqlkug','first_name':'นายบัณฑิต' ,'last_name':'เพ็งเหล็ง'},
            {'username': '6701920235','email': 'None','password': 'ejoimn','first_name':'นายสุรเชษฐ์' ,'last_name':'สีสา'},
            {'username': '6701920279','email': 'None','password': 'cnlyjm','first_name':'นายวงศธร' ,'last_name':'ธน.ยอด'},
            {'username': '6701920306','email': 'None','password': 'wpkjar','first_name':'นางสาวกันยาดา' ,'last_name':'ยุบล'},
            {'username': '6701920363','email': 'None','password': 'xbydcw','first_name':'นายประพุทธ์' ,'last_name':'คำคาวี'},
            {'username': '6701920441','email': 'None','password': 'nnvali','first_name':'นายคาสึมะ' ,'last_name':'นันทรักษ์'},
            {'username': '6701920576','email': 'None','password': 'vainix','first_name':'นางสาวอาฐิรตา' ,'last_name':'รัตนกุล'},
            {'username': '6701920588','email': 'None','password': 'jczlnz','first_name':'นายคมชาญ' ,'last_name':'น้อยเนียม'},
            {'username': '6701920660','email': 'None','password': 'uodqit','first_name':'นายเมธาวัช' ,'last_name':'กลิ่นเกษร'},
            {'username': '6701920854','email': 'None','password': 'ijheif','first_name':'นายณัฏฐกิตติ์' ,'last_name':'คำเพาะ'},
            {'username': '6701920923','email': 'None','password': 'cxesvu','first_name':'นายธนากร' ,'last_name':'หนูมี'},
            {'username': '6701921137','email': 'None','password': 'vkshms','first_name':'นายธนากร' ,'last_name':'ไชยรัตน์'},
            {'username': '6701921255','email': 'None','password': 'crbscl','first_name':'นายธนพงษ์' ,'last_name':'สองสี'},
            {'username': '6701921305','email': 'None','password': 'ygwkov','first_name':'นางสาวกวิณชฎา' ,'last_name':'มีศรี'},
            {'username': '6701921355','email': 'None','password': 'zoecxs','first_name':'นายรัชชานนท์' ,'last_name':'รื่นจิตต์'},
            {'username': '6701921395','email': 'None','password': 'hppndq','first_name':'นายวรินทร' ,'last_name':'เสริมศิริ'},
            {'username': '6701921506','email': 'None','password': 'xepina','first_name':'นายญาณพัทธ์' ,'last_name':'วงศ์ตา'},  
            {'username': '6701921556','email': 'None','password': 'cmikrw','first_name':'นายธนกฤต' ,'last_name':'ผวนชัยภูมิ'},
            {'username': '6701921558','email': 'None','password': 'rriism','first_name':'นายแอนโทนี่' ,'last_name':'ดูบัชนี'},
            {'username': '6701921680','email': 'None','password': 'rtvbkw','first_name':'นายรพีวิชญ์' ,'last_name':'บุญเกื้อ'},
            {'username': '6701921798','email': 'None','password': 'dfcbyi','first_name':'นางสาวพิยดา' ,'last_name':'รักษาเชื้อ'},
            {'username': '6701921924','email': 'None','password': 'pcmobb','first_name':'นายภัครพล' ,'last_name':'คำภู'},  
            {'username': '6701921960','email': 'None','password': 'ktqopb','first_name':'นายอัครชัย' ,'last_name':'พูลสวัสดิ์'}, 
